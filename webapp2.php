	...
	const geoJson = {
        ...
        fetch(url, { mode: 'cors' }) // Use mode 'cors' for cross-origin requests
		    ...
		    geoJson.result.records.forEach(records => {
                 ...
                 prop === 'uucne' ? villageAutocompleteData[`${properties.urcne} &lt;br&gt; ${properties.uscne} - ${properties.uucne}`] = `${properties.urid}-${properties.usid}-${properties.uuid}` : autocompleteDatax[properties[prop]] = null;
